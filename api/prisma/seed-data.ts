...
const HOTELS = [
  // ── Tashkent (9 hotels — 90%) ──────────────────────────────────────────────
  {
    name: 'Hilton Tashkent City',
    slug: 'tashkent-hilton',
    city: 'Tashkent',
    address: 'Islam Karimov Street 2, Tashkent 100029, Uzbekistan',
    phone: '+998712000100',
    ...
    description: {
      ...
      ru: 'Первоклассный 5-звёздочный люкс-отель в центре Ташкента',
    },
  },
  {
    ...
    slug: 'tashkent-hyatt',
    city: 'Tashkent',
    address: '4 Akademik Akhmedov Street, Tashkent 100084, Uzbekistan',
    phone: '+998712001200',
    email: 'tashkent.regency@hyatt.com',
    website: 'https://www.hyatt.com/tashkent',
    taxId: '302845672',
    latitude: 41.3126,
    longitude: 69.2889,
    stars: 5,
    ...
    description: {
      ...
      ru: 'Международный 5-звёздочный отель, сочетающий современный комфорт и узбекское гостеприимство',
    },
  },
  {
    name: 'Radisson Blu Hotel Tashkent',
    slug: 'tashkent-radisson',
    city: 'Tashkent',
    address: '1 Bobur Street, Tashkent 100003, Uzbekistan',
    phone: '+998712002300',
    email: 'info.tashkent@radissonblu.com',
    website: 'https://www.radissonblu.com/tashkent',
    taxId: '302845673',
    latitude: 41.2984,
    longitude: 69.2719,
    stars: 5,
    ...
    description: {
      ...
      ru: 'Современный 5-звёздочный отель в деловом районе с панорамным видом на город',
    },
  },
  {
    name: 'InterContinental Tashkent',
    slug: 'tashkent-intercontinental',
    city: 'Tashkent',
    address: '107A Amir Temur Avenue, Tashkent 100000, Uzbekistan',
    phone: '+998712003400',
    email: 'reservations@ictashkent.com',
    website: 'https://www.ihg.com/intercontinental/tashkent',
    taxId: '302845674',
    latitude: 41.3028,
    longitude: 69.2757,
    stars: 5,
    ...
    description: {
      ...
      ru: 'Культовый 5-звёздочный отель на проспекте Амира Тимура с первоклассными удобствами',
    },
  },
  {
    name: 'Wyndham Tashkent',
    slug: 'tashkent-wyndham',
    city: 'Tashkent',
    address: '12 Movarounnahr Street, Tashkent 100011, Uzbekistan',
    phone: '+998712004500',
    email: 'info@wyndhamtashkent.com',
    website: 'https://www.wyndhamhotels.com/tashkent',
    taxId: '302845675',
    latitude: 41.2910,
    longitude: 69.2620,
    stars: 4,
    ...
    description: {
      ...
      ru: 'Стильный 4-звёздочный отель с отличным соотношением цены и качества в центре Ташкента',
    },
  },
  {
    ...
    slug: 'tashkent-lotte',
    city: 'Tashkent',
    address: '3 Olimlar Street, Tashkent 100170, Uzbekistan',
    phone: '+998712005600',
    email: 'tashkentpalace@lottehotel.com',
    website: 'https://www.lottehotel.com/tashkent',
    taxId: '302845676',
    latitude: 41.3045,
    longitude: 69.2680,
    stars: 5,
    ...
    description: {
      ...
      ru: 'Престижный 5-звёздочный отель в историческом здании в центре Ташкента',
    },
  },
  {
    name: 'Grand Mir Hotel Tashkent',
    slug: 'tashkent-mir',
    city: 'Tashkent',
    address: '2 Mustaqillik Avenue, Tashkent 100000, Uzbekistan',
    phone: '+998712006700',
    email: 'info@grandmir.uz',
    website: 'https://www.grandmir.uz',
    taxId: '302845677',
    latitude: 41.2945,
    longitude: 69.2757,
    stars: 4,
    ...
    description: {
      ...
      ru: 'Комфортабельный 4-звёздочный отель у площади Независимости',
    },
  },
  {
    name: 'ARBA Hotel Tashkent',
    slug: 'tashkent-arba',
    city: 'Tashkent',
    address: '11 Taras Shevchenko Street, Tashkent 100017, Uzbekistan',
    phone: '+998712007800',
    email: 'info@arbahotel.uz',
    website: 'https://www.arbahotel.uz',
    taxId: '302845678',
    latitude: 41.2878,
    longitude: 69.2845,
    stars: 4,
    ...
    description: {
      ...
      ru: 'Современный бутик-отель 4 звезды, предлагающий подлинное узбекское гостеприимство',
    },
  },
  {
    name: 'Hotel Uzbekistan Tashkent',
    slug: 'tashkent-uzbekistan',
    city: 'Tashkent',
    address: '45 Amir Temur Avenue, Tashkent 100084, Uzbekistan',
    phone: '+998712008900',
    email: 'info@hoteluzbekistan.uz',
    website: 'https://www.hoteluzbekistan.uz',
    taxId: '302845679',
    latitude: 41.3054,
    longitude: 69.2823,
    stars: 4,
    ...
    description: {
      ...
      ru: 'Историческая 4-звёздочная ташкентская гостиница с современными удобствами',
    },
  },
  // ── Samarkand (1 hotel — 10%) ──────────────────────────────────────────────
  {
    name: 'Mövenpick Hotel Samarkand',
    slug: 'samarkand-movenpick',
    city: 'Samarkand',
    ...
    description: {
      ...
      ru: 'Отель мирового класса 5 звёзд у исторического города Шёлкового пути',
    },
  },
];
